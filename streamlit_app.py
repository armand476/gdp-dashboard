...
diagnostique=[]
image_url = "https://github.com/armand476/gdp-dashboard/blob/main/Design%20sans%20titre.jpg?raw=true"
...
antécédents2=st.text_input("Le patient a-t-il des antécédents ?")
